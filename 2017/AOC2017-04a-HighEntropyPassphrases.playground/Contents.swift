//: Advent of Code 2017: 4 - High-Entropy Passphrases (Part 1)
...
func isValidPassphrase(input: String) -> Bool {
  ...
  var existingWords = Set<String>(words)
  var isValid = true
...
class TestPassphrases : XCTestCase {
  ...
  func testInput1() {
    let isValid = isValidPassphrase(input: "aa bb cc dd ee")
    XCTAssertEqual(isValid, true)
  }

  func testInput2() {
    let isValid = isValidPassphrase(input: "aa bb cc dd aa")
    XCTAssertEqual(isValid, false)
  }

  func testInput3() {
    let isValid = isValidPassphrase(input: "aa bb cc dd aaa")
    XCTAssertEqual(isValid, true)
  }
}

//: Advent of Code 2018: 1 - Chronal Calibration (Part 1)
// https://adventofcode.com/2018/day/1

import XCTest

func calculateFrequency(input: String, initFrequency: Int = 0) -> Int {
...
calculateFrequency(input: input)
// Correct Answer: 439

class SequenceTests: XCTestCase {
  func testInput1() {
    let sum = calculateFrequency(input: "+1, -2, +3, +1")
    XCTAssertEqual(sum, 3)
  }

  func testInput2() {
    let sum = calculateFrequency(input: "+1, +1, +1")
    XCTAssertEqual(sum, 3)
  }
  ...
  func testInput4() {
    let sum = calculateFrequency(input: "-1, -2, -3")
    XCTAssertEqual(sum, -6)
  }

  func testInputEmpty() {
    let sum = calculateFrequency(input: "")
    XCTAssertEqual(sum, 0)
  }

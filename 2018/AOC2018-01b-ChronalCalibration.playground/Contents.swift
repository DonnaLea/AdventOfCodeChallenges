//: Advent of Code 2018: 1 - Chronal Calibration (Part 2)
// https://adventofcode.com/2018/day/1#part2

import XCTest

func calculateFirstRepeatedFrequency(input: String, initFrequency: Int = 0) -> Int {
  var frequency = initFrequency
  var repeatedFrequency: Int?
  var frequencies: Set<Int> = [initFrequency]
    
  let input = input.split(separator: ",")
  while repeatedFrequency == nil {
    for valueStr in input {
      if let value = Int(valueStr.trimmingCharacters(in: .whitespacesAndNewlines)) {
        frequency += value

...
/*
func processStacks5b(input: String) -> [[String]] {
    var stacks = [[String]]()
...
/*
func parseCrateInputLine5b(input: [String], stacks: inout [[String]]) {
...
func append5b(crate: String, stackIndex: Int, stacks: inout [[String]]) {
...
func process5b(instructions: [Instruction], stacks: inout [[String]]) {
    print("before processing stacks: \(stacks)")
    for instruction in instructions {
        ...
        let cratesToMove = fromStack.suffix(from: fromStack.count-amount)
        fromStack.removeLast(amount)
        toStack.append(contentsOf: cratesToMove)
//        for _ in 0..<amount {

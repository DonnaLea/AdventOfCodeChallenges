//: Advent of Code 2019: 05 - Sunny With A Chance of Asteroids (Part 2)
...
//      print("step 5")
      ...
      if opcode == 5 {
        if firstNumber != 0 {
          print("setting instruction pointer to: \(secondNumber)")
...
let value = calculate(input: input, intInput: 5)
print(value)
